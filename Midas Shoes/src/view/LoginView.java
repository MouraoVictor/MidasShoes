...
public class LoginView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(lbUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 120, 100, 20));
        ...
        getContentPane().add(lbSenha, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 180, 90, 20));
        getContentPane().add(jPasswordFieldSenha, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 200, 220, -1));

        BttnCadastrar.setText("Cadastrar Usuário");
        BttnCadastrar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BttnCadastrarActionPerformed(evt);
            }
        });
        getContentPane().add(BttnCadastrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 300, 150, -1));
        ...
        getContentPane().add(BttnEntrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 260, 150, -1));

        ImgLogo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/imagens/logoMed.png"))); // NOI18N
        getContentPane().add(ImgLogo, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 20, -1, -1));

        imgFundo.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        imgFundo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/imagens/imgInicio.jpg"))); // NOI18N
        imgFundo.setAlignmentY(0.0F);
        getContentPane().add(imgFundo, new org.netbeans.lib.awtextra.AbsoluteConstraints(-30, 0, 480, 400));
